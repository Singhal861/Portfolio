export const env = {
  ...
  smtpHostBr: process.env.SMTP_HOST_BR || '',
  smtpPortBr: Number(process.env.SMTP_PORT_BR || '587'),
  smtpUserBr: process.env.SMTP_USER_BR || '',
  smtpPassBr: process.env.SMTP_PASS_BR || '',
